describe("JS injection testing", function () {
    ...
    it("Checks for JS injection vulnerability on Login Page", function () {
        cy.visit('http://localhost:5289/Account/Login#&lt;script&gt;window.location="www.haxxed.com"&lt;/script#&gt');
        cy.contains("Error").should("not.exist");
    })
    ...
    it("Checks for JS injection vulnerability on Registration Page", function () {
        cy.visit('http://localhost:5289/Account/Register#&lt;script&gt;window.location="www.haxxed.com"&lt;/script#&gt');
        cy.contains("Error").should("not.exist");
    })
